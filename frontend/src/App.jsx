...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/cuentas/nueva" element={<RutaProtegida><FormCuenta /></RutaProtegida>} />
      <Route path="/cuentas/:id/editar" element={<RutaProtegida><FormCuenta /></RutaProtegida>} />
      <Route path="/monedas" element={<RutaProtegida><Monedas /></RutaProtegida>} />
      <Route path="/monedas/nueva" element={<RutaProtegida><FormMoneda /></RutaProtegida>} />
      <Route path="/monedas/:id/editar" element={<RutaProtegida><FormMoneda /></RutaProtegida>} />
